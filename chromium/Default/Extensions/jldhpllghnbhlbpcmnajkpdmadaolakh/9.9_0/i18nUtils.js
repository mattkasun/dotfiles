var i18nUtils = {
     ...
     * by replacing the innerHTML text with translated text
    ...
    localizeHTML: function() {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            if (elm.dataset && elm.dataset.message) {
                var msg = chrome.i18n.getMessage(elm.dataset.message)
                if (msg) {
                    elm.innerHTML = msg
                }
            }
    ...
    getMessage: function(messageName, defaultMessage) {
        return chrome.i18n.getMessage(messageName) || defaultMessage
    }
}
