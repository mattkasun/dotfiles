...
const RateMe = {
    ...
    disableViaAjax: function() {
        doGetRequest(
            "https://" + DOMAIN + "/Tooltips/markAsSeen?name=chrome_rating"
        )
    },
    ...
    showTooltip: function() {
        ...
        if (iframe_loc && iframe_loc.indexOf("/app") != -1) {
            const msg = JSON.stringify({
                ...
                action_url:
                    "https://chrome.google.com/webstore/detail/todoist-to-do-list-and-ta/jldhpllghnbhlbpcmnajkpdmadaolakh/reviews"
            })
    ...
    setShouldShowTooltip: function() {
        doGetRequest(
            "https://" + DOMAIN + "/Tooltips/isSeen?name=chrome_rating",
            function(xhr) {
    ...
    reset: function() {
        ...
        doGetRequest(
            "https://" + DOMAIN + "/Tooltips/resetSeen?name=chrome_rating"
        )
    }
}
